...
const ListenButton: React.FC<ListenButtonProps> = ({ text }) => {
  ...
  return (
    <button
      className={isSpeaking ? `${styles.listenButton} ${styles.speaking}` : styles.listenButton}
    ...
    >
      ...
      <span aria-hidden="true" style={{ marginRight: '0.5em', display: 'inline-flex', alignItems: 'center' }}>
